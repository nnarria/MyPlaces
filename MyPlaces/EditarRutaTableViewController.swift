//
//  EditarRutaTableViewController.swift
//  MyPlaces
//
...
class EditarRutaTableViewController: UITableViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate {
    ...
    func imagePickerController(picker: UIImagePickerController, didFinishPickingImage image: UIImage, editingInfo: [String : AnyObject]?) {
        self.nRuta = self.nombreRuta.text!
        self.dRuta = self.descripcionRuta.text!
        self.iRuta = image
